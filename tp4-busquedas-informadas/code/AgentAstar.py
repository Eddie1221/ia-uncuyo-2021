    ...
    while self.front != []:
        ...
        if Estado == self.obj:
            ...
            if self.up(Estado[0], Estado[1]) == True:
                enqueue(self.front,[Estado[0]-1,Estado[1]],cont+self.grilla[Estado[0]-1][Estado[1]])
            ...
            if self.right(Estado[0], Estado[1]) == True:
                enqueue(self.front,[Estado[0],Estado[1]+1],cont+self.grilla[Estado[0]][Estado[1]+1])
