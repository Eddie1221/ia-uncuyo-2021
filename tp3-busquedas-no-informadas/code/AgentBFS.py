...
class AgentBFS:
    ...
    #Funcion para hacer la busqueda que imprime la grilla y la secuencia, es una funcion wrapper para la funcion recursiva de busqueda a lo ancho
    def think(self):
...
#Funcion recursiva de busqueda a lo ancho implementando cola FIFO
def BFSsearch(self):
        ...
        while self.front.head != None:
            ...
            if Estado == self.obj:
                ...
                if self.up(Estado[0], Estado[1]) == True:
                    ...
                    self.front.enqueue([Estado[0]-1,Estado[1]])
                ...
                if self.right(Estado[0], Estado[1]) == True:
                    ...
                    self.front.enqueue([Estado[0],Estado[1]+1])
